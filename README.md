...
## Split Files Preview
Below is the output of the first 6 lines of each CSV file in the `split_files` folder, as generated by `display_split_files.py`:

```
=== Файл: XAUUSD_1 Min_Ask_2020.01.01_2025.05.25_trimmed.csv ===
